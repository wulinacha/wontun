...
<div class="container">
    ...
    <c:if test="${empty userList}">
        <div class="alert alert-warning" role="alert">
            <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>还没有用户，请<a href="/admin/users/add" type="button" class="btn btn-primary btn-sm">添加</a>
        </div>
    </c:if>
        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${userList}" var="user">
                <tr>
                    ...
                    <td>${user.age}</td>
                    <td>${user.phone}</td>
                    <td><a href="/admin/accounts/${user.id}" type="button" class="btn btn-primary btn-sm">查看账户</a></td>
                    <td>
