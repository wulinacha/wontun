...
<div class="container">
    ...
    <form:form action="/admin/accounts/updatepost" method="post" modelAttribute="account">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <form:input class="form-control" path="password"/><form:hidden path="userid"/><form:hidden path="id"/>
